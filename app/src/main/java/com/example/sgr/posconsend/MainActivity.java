...
import com.example.sgr.posconsend.Conts;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btn0,btn1,btn2,btn3,btn4,btn5,btn6,btn_scan,btn_sb,bt8;
    Spinner spinner;
    EditText et;
    int pos;
    ...
    private void addListener() {
        ...
        btn3.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                byte[] data2=DataForSendToPrinterTSC.text(10, 10, "0", 0, 2, 2, "22aacc");
